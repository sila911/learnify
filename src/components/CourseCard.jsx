    ...
    >
      <div className="relative overflow-hidden h-48">
        ...
        <div className="absolute top-4 right-4 flex flex-col gap-2">
          ...
          <button className="w-8 h-8 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-full flex items-center justify-center text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition shadow-sm">
